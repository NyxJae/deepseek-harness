  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Return whether this exact parent has a live direct continuable child.',
        parameters: [{ name: 'parent', description: 'Agent whose direct child ownership is checked.' }],
