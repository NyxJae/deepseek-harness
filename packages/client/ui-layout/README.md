...
- **Extremely narrow windows** — after the right panel closes, the center may still fall below 400px; the fixed sidebar drawer remains outside the grid.
