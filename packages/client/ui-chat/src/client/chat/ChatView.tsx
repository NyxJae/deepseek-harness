...
export function ChatView({
  ...
  sessionId, openFile, loadOlder, loadThrough, loadImage, resolveMarkdownImage, canResolveMarkdownImage,
  openView, chatScroll, forkAt, fileMentions, useTranscriptView, useProjection, t,
}: ChatViewSlotProps) {
      ...
      <div ref={listRef} className={css.scroll}>
        ...
        <div ref={columnRef} className={css.column} data-chat-flow="">
          ...
          <ChatNodeList
            ...
            resolveMarkdownImage={canResolveMarkdownImage?.() === true ? resolveMarkdownImage : undefined}
