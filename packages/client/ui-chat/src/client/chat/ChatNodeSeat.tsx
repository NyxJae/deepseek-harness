...
export const ChatNodeSeat = memo(function ChatNodeSeat({
  ...
  loadImage, renderMessageImages, resolveMarkdownImage, fileMentions, useStore, actions, renderSlot, t,
}: ChatNodeSeatProps) {
  ...
  const owner = useMemo<ChatNodeOwnerProps | null>(() => node === undefined
    ...
    loadImage, renderMessageImages, resolveMarkdownImage, fileMentions, turnProcess,
  ])
