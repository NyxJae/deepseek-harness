...
Use this package to provide Settings, connection recovery, feature-contributed navigation, and sequential first-run onboarding. The desktop dialog is up to 800px square; at widths of 640px and below it fits the safe-area viewport with horizontal section navigation and independently scrolling content. Tab and Shift+Tab stay in the open dialog, and an open Menu handles Escape before Settings closes. Users can retry failed connections and access a local configuration file on eligible loopback hosts; feature packages supply their own rows, sections, and onboarding steps.
