...
- A process crash after content-addressed attachment publication but before the mapping event can leave an unreferenced object; reference-aware attachment garbage collection is deferred.
